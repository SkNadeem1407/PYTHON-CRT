...
Players register play matches, and earn points. The system should rank them, handle tiebreakers, and simulate knockout rounds. 
Features:
Player registration with unique usernames.
Match results entry and automatic point updates. 
Leaderboard sorted by score. Simulate knockout using recursion. 
Export match history. 
Tech Stack:
Core Python (Lists, Dictionaries, Tuples)
OOP (Player, Match, Tournament clases)
